                                                                    ...
                                                                    Container(
                                                                        child: Column(
                                                                          ...
                                                                          ClipRRect(
                                                                              ...
                                                                              child: CommonImageView(imagePath: ImageConstant.imgEllipse, height: getSize(60.00), width: getSize(60.00))),
                                                                          Align(
                                                                              alignment: Alignment.center,
                                                                              child: Padding(padding: getPadding(top: 28, right: 2), child: Text("lbl_recom".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsBold16Gray900.copyWith())))
                                                                        ])),
                                                                    Container(
                                                                        margin: getMargin(
                                                                            bottom:
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(padding: getPadding(top: 10, right: 10), child: Text("msg_monday_06_30_w".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular11.copyWith()))
                                                                            ]))
                                                                  ]))),
                                                      Align(
                                                          alignment: Alignment
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                        margin: getMargin(
                                                                            ...
                                                                            bottom:
                                                                                2),
                                                                        decoration: AppDecoration.outlineLightblue5012.copyWith(
                                                                        ...
                                                                        child: Row(
                                                                            ...
                                                                            children: [
                                                                              Padding(padding: getPadding(left: 15, top: 39, bottom: 38), child: CommonImageView(imagePath: ImageConstant.imgSignal46X75, height: getVerticalSize(46.00), width: getHorizontalSize(75.00))),
                                                                              Container(
                                                                                  margin: getMargin(left: 20, top: 24, right: 25, bottom: 24),
                                                                                  child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                    Padding(padding: getPadding(right: 10), child: Text("lbl_21_00".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtPoppinsBold14.copyWith())),
                                                                                    Padding(padding: getPadding(right: 10), child: Text("lbl_sleep_time".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtPoppinsRegular12.copyWith())),
                                                                                    Align(alignment: Alignment.centerRight, child: Container(margin: getMargin(left: 10, top: 18), padding: getPadding(left: 22, top: 2, right: 22, bottom: 2), decoration: AppDecoration.txtFillWhiteA700.copyWith(borderRadius: BorderRadiusStyle.txtRoundedBorder8), child: Text("lbl_done".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtPoppinsMedium10.copyWith())))
                                                                                  ]))
                                                                            ]))
                                                                  ]))),
                                                      Padding(
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                              ...
                                                                              Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(top: 28), child: CommonImageView(imagePath: ImageConstant.imgRectangle25, height: getVerticalSize(189.00), width: getHorizontalSize(335.00))))
                                                                            ]))),
                                                                    Align(
                                                                        alignment:
